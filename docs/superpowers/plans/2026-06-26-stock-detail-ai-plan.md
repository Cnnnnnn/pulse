...
describe("fetchValuation", () => {
  ...
  it("falls back to tencent on eastmoney failure", async () => {
    const tencentBody = `v_sh600519="1,贵州茅台,600519,2000,1950,200,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,1500,28.5,2026-06-25,1500,1500,30,50,1500,1500,1500,1500,1500"`;  // 50 个字段满足 parts.length >= 50 (parseTencent 校验)
