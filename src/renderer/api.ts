...
export function createApi(overrides: Record<string, any> = {}): RendererApi {
  return {
    ...
    goofishGetPrefs: pick(overrides, "goofishGetPrefs"),
    goofishSetPrefs: pick(overrides, "goofishSetPrefs"),
    goofishCheckNow: pick(overrides, "goofishCheckNow"),
    goofishGetAuth: pick(overrides, "goofishGetAuth"),
    ...
    onGoofishAuth: pick(overrides, "onGoofishAuth"),
