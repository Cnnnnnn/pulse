...
> = {
  ...
  underline: {
    ...
    tab: "category-tab",
    active: "active",
    count: "category-tab-count",
    icon: "category-tab-icon",
    name: "category-tab-name",
  },
  pill: {
    list: "recent-modal-filters",
    tab: "recent-filter-pill",
    active: "is-active",
  },
  date: {
    list: "ai-tasks-date-row",
    tab: "ai-tasks-date-chip",
    active: "active",
  },
  config: {
    list: "ai-config-tabs",
...
export function TabList({
  ...
  return (
    <div
      class={`${v.list}${className ? ` ${className}` : ""}`}
      role={role}
