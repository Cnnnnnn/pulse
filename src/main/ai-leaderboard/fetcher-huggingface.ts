...
/**
 * ponytail: HF trending 分数 (v2.79.6+) — 见 src/shared/ai-leaderboard-trending.ts.
 * 这里 re-export 维持向后兼容 (ranking.ts / tests 仍 import 自本文件).
 *
 * 公式 / 守卫细节看 shared 模块文件头注释.
 */
 ...
 */
async function fetchPage(opts: any = {}): Promise<any[]> {
