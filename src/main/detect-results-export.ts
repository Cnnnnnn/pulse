/**
 * src/main/detect-results-export.ts
 *
 ...
 * @returns {object|null}
 */
export function pickExportFields(app: any): any {
 ...
 */
export function buildExportPayload(state: any, pulseVersion: string = ""): any {
 ...
 */
export function exportDetectResults(opts: any): any {
  const {
    state,
    format,
