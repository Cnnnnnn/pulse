 ...
 */
export function saveApiKey(providerId: any, apiKey: any, log: any = SILENT_LOG) {
 ...
 */
export function loadApiKey(providerId: any, log: any = SILENT_LOG) {
 const ss = _tryGetSafeStorage();
 if (!ss) return null;
 ...
 * @returns {boolean}
 */
export function clearApiKey(providerId: any, log: any = SILENT_LOG) {
