/**
 * src/ai-sessions/sqlite-helper.ts
 *
 ...
 */
export function loadNodeSqlite(log: any = SILENT_LOG) {
  try {
...
export async function listSessionsViaCli(sqlitePath: any, log: any = SILENT_LOG) {
  const sql =
...
export async function readSessionViaCli(sqlitePath: any, sessionId: any, log: any = SILENT_LOG) {
