...
import { dateKeyToMs } from "./date-utils";
import { looksLikePromptNoise } from "./text-utils";

export class TaskSummaryEngine {
  detectors: any;
  summarizer: any;
  storage: any;
  config: any;
   ...
   */
  constructor({ detectors, summarizer, storage, config, log }: any = {}) {
