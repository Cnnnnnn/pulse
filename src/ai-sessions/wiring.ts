...
import { CursorDetectorImpl } from "./cursor";
import { CodexDetectorImpl } from "./codex";
import { MiniMaxCodeDetectorImpl } from "./minimax-code";
import { LLMSummarizer } from "./summarizer";
import { CloudSummarizer } from "./provider-cloud";
 ...
 */
export function buildTaskSummaryEngine(opts: any = {}) {
