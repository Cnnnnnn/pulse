/**
 * src/ai-sessions/provider-cloud.ts
 *
...
export const DEFAULT_TIMEOUT_MS =120_000; //跟 ollama 一致
 ...
 */
 async healthcheck({ config, httpClient }: any = {}) {
