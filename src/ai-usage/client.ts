 ...
 * @returns {string}
 */
export function _resolveEndpoint(opts: any = {}) {
...
export class MiniMaxQuotaClient {
  apiKey: any;
  region: any;
  endpoint: any;
  httpClient: any;
  log: any;
  _customHttpClient: any;
  _inFlight: any;
  _summaryInFlight: any;
   ...
   */
  async fetchUsageSummaryOnce(opts: any = {}) {
  ...
  async _doFetchUsageSummary(opts: any = {}) {
