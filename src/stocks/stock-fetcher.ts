...
import { MARKET_PARAM, FIELD_MAP, FIELDS_PARAM, SORT_KEY_TO_FID, DEFAULT_FID } from "./stock-constants";
import { fetchStocksSina } from "./sina-fetcher";
 ...
 */
export async function fetchStocksByCodes(codes: any, httpClient: any, opts: any = {}) {
