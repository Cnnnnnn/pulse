...
export const MARKET_PARAM = "m:0+t:6,m:0+t:80,m:1+t:2,m:1+t:23";
...
export const FIELDS_PARAM = Object.values(FIELD_MAP).join(",");
...
export const DEFAULT_FID = "f173"; // 按 ROE 降序

export const MARKET_CAP_TIERS = ["all", "large", "mid", "small"];

// 市值阈值 (元). large>500亿, mid 100-500亿, small<100亿.
export const MARKET_CAP_LARGE = 5e11; // 500亿
export const MARKET_CAP_MID = 1e11; // 100亿
...
export const DEFAULT_SCREENER_CRITERIA = {
  peMin: null,
  peMax: null,
  pbMin: null,
  pbMax: null,
