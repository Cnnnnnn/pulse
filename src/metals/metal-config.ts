...
//   国际金/银/汇率: 新浪 hf_GC/hf_SI/USDCNY (Yahoo v8 chart 已挂, 详见 metal-sina-hf-fetcher.ts)
//   国内金/银: 东方财富 118.AU9999/118.AG9999 (新浪 AU0/AG0 已停更, 返回 2024 陈旧数据).
//     东方财富 f43 是整数, 不同品种除数不同 (见 metal-eastmoney-fetcher.ts):
