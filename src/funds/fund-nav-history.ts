...
export async function fetchFundNavHistory(code: any, httpClient: any, opts: any = {}) {
 ...
 */
export function parseIndexResponse(json: any) {
  const list =
 ...
 */
export async function fetchIndexHistory(symbol: any, httpClient: any, opts: any = {}) {
