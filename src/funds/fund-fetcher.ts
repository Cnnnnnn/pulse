 ...
 * }>}
 */
export async function fetchFundNav(code: any, httpClient: any, opts: any = {}) {
 ...
 */
export function parseJsonpgz(body: any) {
 ...
 */
export function mapFundData(raw: any) {
 ...
 */
export async function fetchFundNavWithAlt(code: any, httpClient: any, opts: any = {}, health?: any) {
