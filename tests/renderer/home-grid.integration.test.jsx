...
describe('HomeGrid navStore 集成路径', () => {
  ...
  it('PERSISTABLE_NAV_KEYS 不含 home', async () => {
    ...
    // ponytail: feat/i3v4-invest-nav-merge 不含 newcar (它是 separate PR),
    //   newcar 合并后此处 + HomeGrid tile 数 + navStore 都会再加 1, 届时再 bump 到 6.
...
// ponytail: feat/i3v4-invest-nav-merge 不含 newcar (separate PR), newcar 合并后
//   此处 + HomeGrid tile 数 + PERSISTABLE_NAV_KEYS 都会再加 1, 届时再 bump.
