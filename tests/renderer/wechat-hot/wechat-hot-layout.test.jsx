 ...
 * - 渲染 WechatHotHeader + WechatHotList.
...
beforeEach(() => {
  ...
  mockApplyPayload.mockReset();
  mockRefresh.mockReset();
  for (const k of Object.keys(signals)) signals[k].value = signals[k].value; // keep
...
describe("WechatHotLayout", () => {
  ...
  it("renders Header + List", () => {
    ...
    expect(container.querySelector(".wechat-hot-list")).toBeTruthy();
  });
